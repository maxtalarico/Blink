...
public class HistoryListAdapter extends BaseAdapter implements ListAdapter {
    ...
    public HistoryListAdapter(ArrayList<String> list, History context) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TextView tvNumeroCartao = (TextView)view.findViewById(R.id.cartaoValor);
        tvNumeroCartao.setText(list.get(position).split(";")[3] + " - " + list.get(position).split(";")[4]);
